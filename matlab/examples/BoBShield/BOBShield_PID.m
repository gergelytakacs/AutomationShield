...
%
%   PID feedback control of ball altitude in the BobShield.
%
...
BobShield=BobShield;        % Create BobShield object from BobShield class
BobShield.begin('COM3', 'UNO'); % Initialise shield with used Port and Board type
BobShield.calibrate();          % Calibrate BobShield
...
while (1)                                     % Lift the ball off the ground
    ...
    y = BobShield.sensorRead();             % Read ball position
