...
% select a type of model to identify 
%modelType = 'nonlinear';
modelType = 'linear';


load Identification_Data.mat                      % load file with experimental data for identification
Ts = 0.015;                                       % [s] Sampling time
...
load Validation_Data.mat                    % load file with experimental data for model validation
Ts = 0.015;                                 % [s] Sampling time
