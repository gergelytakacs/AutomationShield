%   MAGNETOSHIELD MATLAB MINIMAL COMMUNICATION SPEED TEST
%
%   This example tests for the absolute minimal sampling period that is 
%   achievable with this shield using MATLAB. Although it is possible to
...
A = arduino('COM15',platfrm,'Libraries','I2C');                      % Creates arduino object
...
add = scanI2CBus(A,busno);                                          % Scans I2C bus for the MCP DAC chip
DAC = device(A,'I2CAddress',add{1,1},'bus',busno,'bitrate',400000); % Initializes I2c communication
...
legend('MagnetoShield MATLAB Communication Speed Test')             % Legend
