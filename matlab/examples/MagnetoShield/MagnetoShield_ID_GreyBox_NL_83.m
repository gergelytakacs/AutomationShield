...
Parameters    = [K; m; R; L; g; C];    % Initial parameter vector.
...
nlModel.Parameters(2).Minimum = m/1.1;    % 10% change allowed
nlModel.Parameters(2).Maximum = m*1.1;    % 10% change allowed
nlModel.Parameters(3).Minimum = R/1.1;    % 10% change allowed
nlModel.Parameters(3).Maximum = R*1.1;    % 10% change allowed
...
nlModel.Parameters(6).Minimum = 0;%C
