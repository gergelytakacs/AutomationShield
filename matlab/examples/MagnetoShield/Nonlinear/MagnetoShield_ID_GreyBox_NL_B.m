...
%sys.SimulationOptions.Solver='auto';  %ode45 is default
%sys.SimulationOptions.RelTol=1E-6 %1E-3
%sys.SimulationOptions.AbsTol=1E-9 %1E-6
%sys.SimulationOptions.MinStep='auto'
%sys.SimulationOptions.MaxStep=1E-3
%sys.SimulationOptions.InitialStep=1E-3
...
opt.SearchMethod = 'lm'; %lm, gn, gna, lsqnonlin, fmincon
